...
public class TestBookObjectStream {
	...
	public static void main(String[] args) {
		...
		do
		{
			...
			case 8: 
				...
				try(FileOutputStream fout = new FileOutputStream("BookDetails.txt"))
				{
			...
			case 9:
				List<Book>book;
				try(FileInputStream fin = new FileInputStream("BookDetails.txt"))
			{
				try(ObjectInputStream oin = new ObjectInputStream(fin))
				{
						book = (List<Book>) oin.readObject();
